 ...
 * 
 * MyDouble objects represent floating point values. The MyDouble is immutable.
 * 
 * @author Fawzi Emad & Jan Plane & Ben Bederson & Evan Golub
 */
...
public class MyDouble {
	 ...
	 * their own Polynomial toString method. (Otherwise, they can convert the
	 * String to type double and bypass the "fun".)
	 */
	public static boolean toStringUsed = false; // set to true in toString.
	...
	/**
	 * Returns a new MyDouble initialized to the value represented by the
	 ...
	 *             - if the string does not contain a parsable MyDouble.
	 */
	 ...
	 * 
	 * @param passedDouble
	 *            value to be "wrapped" in the object
	 */
	...
	/**
	 * Copy Constructor. Initializes the new MyDouble object so that it
	 * represents the same value as that of the parameter.
	 * 
	 * @param passedMyDouble
	 *            existing MyDouble object that is being copied
	 */
	...
	/**
	 * Returns the sum of the current object and the parameter. Note: This
	 * method does not modify the current object.
	 * 
	 * @param passedVal
	 *            the value that serves as the second operand for the addition
	 * @return a MyDouble object that represents the sum of the current object
	 *         and the parameter
	 */
	 ...
	 * current object. Note: This method does not modify the current object.
	 * 
	 * @param passedVal
	...
	/**
	 * Returns the product of the current object and the parameter. Note: This
	 * method does not modify the current object.
	 * 
	 * @param passedVal
	 *            the value that serves as the second operand for the
	 *            multiplication
	 ...
	 * parameter. Note: This method does not modify the current object.
	 * 
	 * @param passedVal
	 *            the value that serves as the divisor
	...
	/**
	 * Returns a MyDouble representing the square of the current object. Note:
	 * This method does not modify the current object.
	 * 
	 * @return the square of the current object
	 */
	public MyDouble square() {
		return new MyDouble(this.doubleValue * this.doubleValue);
	}
	 ...
	 * @return a negative value if the current object is less than the
	 *         parameter, zero if the current object equals the parameter, a
	 *         positive value if the current object is larger than the
	 *         parameter. NOTE: Due to the lack of precision in comparing
	 ...
	 * 
	 * @param passedVal
	 *            the object being compared for equality with the current object
	 ...
	 * 
	 * @return true if the current object is equal to 0, false otherwise. NOTE:
	 *         Due to the lack of precision in comparing floating point values,
	 *         in cases where the value is NEARLY 0, this method will return
	 *         true.
	 */
	...
	/**
	 * YOU MAY NOT CALL THIS METHOD EXCEPT WHILE YOU ARE IMPLEMENTING THE
	 * toString METHOD OF THE Polynomial CLASS!!
	 * 
	 * Returns a String representation of the current object. If the fractional
	 * part of the string is 0, then it is converted in integer format. E.g.,
	 * the number 23.7 is converted to the string "23.7", but the number 23.0 is
	 * converted to the string "23.0"
	 */
